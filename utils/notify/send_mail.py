...
class SendEmail:
    ...
    def send_mail(cls, user_list: list, sub, content: str) -> None:
        ...
        @return:
        """
        user = "Sunny" + "<" + config.email.send_user + ">"
    ...
    def send_main(self, cov) -> None:
        ...
        {self.allure_data.get_passed_cases_detail()}
        **********************************
        gitlab：https://gitlab.ethh.com/Sam/prop_trading_pyauto/-/tree/py_sunny
        非相关负责人员可忽略此消息。谢谢。
        """
        self.send_mail(user_list, sub, content + cov)
