...
class CaseData:
    ...
    def get_case_method(
        ...
        try:
            ...
            _case_method = case_data.get('method', 'POST')
    ...
    def get_request_type(self, case_id: Text, case_data: Dict) -> Text:
        ...
        try:
            ...
            _request_type = str(case_data.get('requestType', 'json'))
    ...
    def get_is_run(
        ...
        try:
            ...
            if config.execution_type == 1:
                ...
                return case_data.get('is_run', 'false')
            else:
                # 冒烟测试，yaml文件未注明的用例，默认都执行
                return case_data.get('is_run', 'true')
        except KeyError as exc:
            raise ValueNotFoundError(
